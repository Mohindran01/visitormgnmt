...
<?php
//todays visitors
 $query4=mysqli_query($con,"select date_format( EnterDate, '%H' ) as `hour` from tblvisitor group by date_format( EnterDate, '%H' ) order by count(*) desc limit 1");
$maximum_visitors=mysqli_fetch_row($query4);
                                ...
                                <div class="overview-item overview-item--c4">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                <h2><?php echo $maximum_visitors[0];?>"Hrs"</h2>
                                                <span>Maximum  Visitors at</span>
                                            </div>
                                        </div>
